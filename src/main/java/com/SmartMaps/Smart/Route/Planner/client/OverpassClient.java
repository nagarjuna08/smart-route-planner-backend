...
public class OverpassClient {
    ...
    public List<PlaceResponse> fetchPlaces(
        ...
        try {
            ...
            OverpassApiResponse apiResponse =
                    mapper.readValue(
                            response,
            ...
            List<PlaceResponse> places =
                    new ArrayList<>();
            Map<Long, PlaceResponse> uniquePlaces =
                    new HashMap<>();

            for (OverpassElement element :
                    apiResponse.getElements()) {
